...
@make_png_animation(10, "img/wine-dtree-maxdepth-dash.png")
...
def png_write(png_file_path):
    ...
    # Write the HTML, cf. PNG   html.Img(src='data:image/png;base64,{}'.format(b64))
    return html.Img(src='data:image/png;base64,{}'.format(b64))
...
app.layout = html.Div([
          ...
          png_write("img/wine-dtree-maxdepth-dash.png")
    ])
